...
class Cart {
    ...
    addToCart(productId, name, price, image, artist) {
        ...
        //regla: máximo 5 unidades por producto
        if (existingItem && existingItem.quantity >= 5) {
            alert('No puedes agregar más de 5 unidades del mismo producto al carrito');
            return;
        }
        
        //regla: máximo 10 productos diferentes en el carrito
        if (!existingItem && this.items.length >= 10) {
        ...
        alert(`${name} agregado al carrito exitosamente`);
    }
    ...
    //actualizar cantidad de un producto con validaciones
