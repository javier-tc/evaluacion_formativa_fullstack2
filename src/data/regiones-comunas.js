export const regionesComunas = [
  ...
  {
    region: "Valparaíso",
    comunas: ["Valparaíso", "Casablanca", "Concón", "Juan Fernández", "Puchuncaví", "Quintero", "Viña del Mar", "Isla de Pascua", "Los Andes", "Calle Larga", "Catemu", "Llay-Llay", "Panquehue", "Putaendo", "San Esteban", "San Felipe", "Santa María", "Quilpué", "Limache", "Olmué", "Villa Alemana", "Quillota", "Calera", "Hijuelas", "La Cruz", "Nogales", "San Antonio", "Algarrobo", "Cartagena", "El Quisco", "El Tabo", "Santo Domingo", "Petorca", "Cabildo", "La Ligua", "Papudo", "Zapallar"],
  },
  {
...
export const getComunasByRegion = (region) => {
  const regionData = regionesComunas.find(r => r.region === region);
  return regionData ? regionData.comunas : [];
};

//función para obtener todas las regiones
export const getAllRegiones = () => {
  return regionesComunas.map(r => r.region);
};

//función para validar si una comuna pertenece a una región
export const isValidComunaForRegion = (region, comuna) => {
